# Error Codes - Instagram Platform
...
| `400` | `352` | `2207026` | `The video format is not supported. Please check spec for supported` {video} `format` | Unsupported video format. Advise the app user to upload an MOV or MP4 (MPEG-4 Part 14). See [Video Specifications](instagram-api/reference/ig-user/media.md#video-specifications). |
