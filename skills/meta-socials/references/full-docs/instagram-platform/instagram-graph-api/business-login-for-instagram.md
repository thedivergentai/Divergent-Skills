...
Source: https://developers.facebook.com/docs/instagram-platform/instagram-graph-api/business-login-for-instagram

# Facebook Login for Business

Facebook Login for Business is a custom, [manual Facebook Login flow](facebook-login/guides/advanced/manual-flow.md) that makes it easier for you to onboard Instagram users who still need to configure their account for API access.
